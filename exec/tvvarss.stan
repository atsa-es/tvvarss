data {
  ...
  int<lower=0> shared_r[n_spp,n_unique_obs+1]; // matrix indicating which sites/spp share obs variances
...
transformed parameters {
  ...
  matrix<lower=0>[n_spp, n_unique_obs] obs_mat;
