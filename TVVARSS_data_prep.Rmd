...
The original data were collected at 7 sites around San Nicolas, but we only model the dynamics of 6 of them. The seventh site, Sandy Cover, was added relatively late in the study, is relatively dep compared to the other sites, and was surveyed with much less frequency. We assume that there are 4 underlying "states", or realizations of the San Nicolas community (see table below). In the North region, we treat site 1 as a single observation of one state. In the West region, we treat sites 2 and 3 as samples from the same state. In the South region, we model 2 different states. Sites 4 and 5 are observations of a third state, and site 6 is from a fourth state.
