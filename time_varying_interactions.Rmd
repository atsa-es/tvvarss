---
title: Time varying vector autoregressive state space modeling of multi-site community
  dynamics
...
## Overview
This file accompanies the Scheuerell et al. paper describing a new method for estimating time varying community interactions (e.g., predation, competition) from multivariate time series data. The general model framework follows from the original MAR(1) of Ives et al. (2003), and subsequent state-space versions of Ives and Dakos (2012).

## Loading in the data
We begin with the original data of Kenner et al. (2013), which are available from the ESA Archives at
...
attach.jags(jags.model)
  hist(EE[,14,1], 20, col="grey", xlab="", main = "Effect of harvest on urchins", cex.main=0.9, cex.axis=0.9)
