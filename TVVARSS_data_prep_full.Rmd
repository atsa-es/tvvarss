...
for(i in 1:14) {
  ...
  plot(estMed, YY_2[i,], col = "red", pch=16, cex=0.8, main = spec.names[i], xlab="Estimated", ylab="Observed", cex.main=0.9)
  points(estMed, YY_3[i,], col = "blue", pch=16, cex=0.8)
  abline(0,1)
}
```
...
for(i in 1:14) {
  ...
  plot(estMed, YY_1[i,], col = "red", pch=16, cex=0.8, main = spec.names[i], xlab="Estimated", ylab="Observed", cex.main=0.9)
  abline(0,1)
}
```
...
for(i in 1:14) {
  ...
  plot(estMed, YY_4[i,], col = "red", pch=16, cex=0.8, main = spec.names[i], xlab="Estimated", ylab="Observed", cex.main=0.9)
  points(estMed, YY_5[i,], col = "blue", pch=16, cex=0.8)
  abline(0,1)
}
```
...
for(i in 1:14) {
  ...
  plot(estMed, YY_6[i,], col = "red", pch=16, cex=0.8, main = spec.names[i], xlab="Estimated", ylab="Observed", cex.main=0.9)
  abline(0,1)
}
```
...
for(i in 1:14) {
  ...
  points(YY_2[i,], col="red", pch=16, cex=0.8)
  points(YY_3[i,], col="blue", pch=16, cex=0.8)
}
```
...
for(i in 1:14) {
  ...
  Xs = seq(1,dim(X_1)[3])
  polygon(c(Xs, rev(Xs)), c(lowerCI, rev(upperCI)), border=NA, col="grey")
  points(YY_1[i,], col="red", pch=16, cex=0.8)
}
```
...
for(i in 1:14) {
  ...
  Xs = seq(1,dim(X_3)[3])
  polygon(c(Xs, rev(Xs)), c(lowerCI, rev(upperCI)), border=NA, col="grey")
  points(YY_4[i,], col="red", pch=16, cex=0.8)
  points(YY_5[i,], col="blue", pch=16, cex=0.8)
}
```
...
for(i in 1:14) {
  ...
  Xs = seq(1,dim(X_4)[3])
  polygon(c(Xs, rev(Xs)), c(lowerCI, rev(upperCI)), border=NA, col="grey")
  points(YY_6[i,], col="red", pch=16, cex=0.8)
}
```
